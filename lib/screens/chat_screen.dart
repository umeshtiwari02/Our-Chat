      ...
      child: SafeArea(
        child: WillPopScope(
          ...
          child: Scaffold(
            ...
            backgroundColor: const Color.fromARGB(255, 213, 230, 245),
                ...
                if (_showEmoji)
                  SizedBox(
                    ...
                    child: EmojiPicker(
                      ...
                      config: Config(
                        bgColor: const Color.fromARGB(255, 213, 230, 245),
                        columns: 7,
        ...
        children: [
          ...
          Expanded(
            child: Card(
              ...
              child: Row(
                children: [
                  // taking image form camera button
                  IconButton(
                      onPressed: () async {
                  ...
                  // taking an image form gallary button
                  IconButton(
                      onPressed: () async {
                        final ImagePicker picker = ImagePicker();
